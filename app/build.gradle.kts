...
val majorVersionNumber = "git rev-list origin/master --merges --count".runCommand().trim().toInt()
val buildVersion: String by lazy {
    val commitsOnMasterBranch="git rev-list origin/master --count".runCommand().trim().toInt()
    val commitsOnDevelopBranch="git rev-list origin/develop --count".runCommand().trim().toInt()
    val minorVersionNumber = commitsOnDevelopBranch - commitsOnMasterBranch
    "0.$majorVersionNumber.$minorVersionNumber"
}
...
android {
    ...
    defaultConfig {
        ...
        minSdkVersion(19)
        targetSdkVersion(28)
        versionCode = if (majorVersionNumber == 0) 1 else 0
